...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const data = {
        ...
        aidaCodes: [
            ...
            { code: "MGF", description: "GUARDIA FISICA 24 HORAS", category: "Turno", value: "+17h" },
            { code: "MGH", description: "MAÑANA+GUARDIA FÍSICA 17 HORAS", category: "Turno", value: "+14–17h" },
            { code: "MGL", description: "MAÑANA+GUARDIA LOCALIZADA 17 HORAS", category: "Turno", value: "+7h+activaciones" },
            { code: "MLG", description: "GUARDIA 24 HORAS LOCALIZADA", category: "Turno", value: "0h (no descuenta)" },
