...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const data = {
        ...
        aidaCodes: [
            ...
            { code: "DPI", description: "DEBER PÚBLICO INEXCUSABLE", category: "Permiso", computo: 7 },
            { code: "ENF", description: "ENFERMEDAD COMÚN/PROFESIONAL", category: "Ausencia", computo: 7 },
            { code: "ESB", description: "ENFERMEDAD SIN BAJA", category: "Ausencia", computo: 7 },
            { code: "ESN", description: "ENFERMEDAD SIN BAJA (REP. NÓMINA)", category: "Ausencia", computo: 7 },
            { code: "FEF", description: "COMPENSACIÓN FESTIVO 24/31 DICIEMBRE", category: "Compensación", computo: 7 },
            ...
            { code: "GRF", description: "GUARDIA 24 HORAS FORMACIÓN", category: "Turno", computo: 24 },
            { code: "LDN", description: "LIBRE DISPOSICIÓN AÑO ANTERIOR", category: "Permiso", computo: 7 },
            { code: "LIB", description: "LIBRE DISPOSICIÓN", category: "Permiso", computo: 7 },
            { code: "LTA", description: "LIBRE DISPOSICIÓN TRIENIOS AÑO ANTERIOR", category: "Permiso", computo: 7 },
            { code: "LDT", description: "LIBRE DISPOSICIÓN TRIENIOS", category: "Permiso", computo: 7 },
            { code: "LIS", description: "LIBERADO SINDICAL", category: "Permiso", computo: 7 },
            { code: "MAN", description: "MAÑANAS 7 HORAS", category: "Turno", computo: 7 },
            { code: "MAA", description: "MAÑANAS 7,30 HORAS", category: "Turno", computo: 7.5 },
            { code: "MGF", description: "GUARDIA FISICA 24 HORAS", category: "Turno", computo: 24 },
            { code: "MGH", description: "MAÑANA+GUARDIA FÍSICA 17 HORAS", category: "Turno", computo: 17 },
            { code: "MGL", description: "MAÑANA+GUARDIA LOCALIZADA 17 HORAS", category: "Turno", computo: 17 },
            ...
            { code: "PCM", description: "PERMISO CONSULTA MÉDICA", category: "Permiso", computo: 4 },
            ...
            { code: "MRG", description: "MAÑANA+GUARDIA FORMACIÓN 17 HORAS", category: "Turno", computo: 17 },
            ...
            { code: "VAA", description: "DIAS VACACIONES POR ANTIGÜEDAD", category: "Vacaciones", computo: 7 },
            { code: "VAC", description: "VACACIONES", category: "Vacaciones", computo: 7 },
            { code: "VAP", description: "VACACIONES PENDIENTES AÑO ANTERIOR", category: "Vacaciones", computo: 7 },
            { code: "VVP", description: "VACACIONES ANTIGÜEDAD AÑO ANTERIOR", category: "Vacaciones", computo: 7 }
    ...
    function updateVacationInfo() {
        ...
        totalVacationDaysSpan.textContent = `${currentVacationDays} días`; // Simplified this line
    ...
    function updateLdInfo() {
        ...
        totalLdDaysSpan.textContent = `${currentLdDays} días`; // Simplified this line
    ...
    function updateSummary() {
        ...
        // Update the main "Total Días de Descanso" to show the sum of all remaining days
